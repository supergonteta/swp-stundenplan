 ...
 * 
 */
public final class AddSubjectDialog extends JDialog implements PropertyChangeListener, ListSelectionListener {
     ...
     * verwendet wird.
     */
    private static final String MSG_OK = Messages.getString("AddSubjectDialog.OK");
     ...
     */
    public AddSubjectDialog(final JFrame owner) {
        super(owner, Messages.getString("AddSubjectDialog.AddSubject"), true);
        ...
        final String[] buttonLabels = { MSG_OK, Messages.getString("AddSubjectDialog.Cancel") };
    ...
    /**
     * Löscht die Elemente des SubjectListModel und setzt den Dialog auf unsichtbar.
     */
